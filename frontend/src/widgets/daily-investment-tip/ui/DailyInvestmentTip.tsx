...
export default async function DailyInvestmentTip() {
  ...
  return (
    <div className="flex h-[80px] items-center space-x-[20px] rounded-md border border-gray-20 bg-gray-0 p-[16px] mobile:flex-col mobile:items-start mobile:space-x-0 mobile:space-y-[20px] mobile:rounded-none mobile:border-none mobile:px-[20px]">
