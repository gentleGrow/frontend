...
from app.module.asset.model import StockWeekly


class StockWeeklyRepository:
    @staticmethod
    async def bulk_upsert(session: AsyncSession, stock_dailies: list[StockWeekly]) -> None:
        stmt = mysql_insert(StockWeekly).values(
            [
                {
