...
from data.sources.stock_info import get_oversea_current_price, get_oversea_stock_code_list
...
async def main():
    ...
    stock_code_list = get_oversea_stock_code_list()

    for stock_code, stock_name, excd in stock_code_list:
